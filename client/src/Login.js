export default function Login() {
  const input = (id) => (
    <>
      ...
      <input
        className="w-full p-2 my-2 text-gray-500 rounded-lg focus:outline-none bg-gray-100"
  ...
  const shadow =
    ' absolute rounded-lg shadow-lg hover:shadow transition duration-300 ease-in-out xl:visible invisible ';

  return (
    <div className="h-full flex justify-center items-center md:flex-row flex-col overflow-hidden">
    <div className="h-full w-full fixed">
      ...
      <div className="bg-gray-700 md:bg-indigo-300 m-2 p-4 sm:w-80 h-96 shadow-lg rounded-lg flex flex-col justify-center items-center hover:shadow transition duration-300 ease-in-out">
